<?php 
error_reporting(0);
define( "FB_ACCOUNT_KIT_APP_ID", "1631807450445260" );
// ID ỨNG DỤNG: 1631807450445260 của Hà Nội Phố
define( "FB_ACCOUNT_KIT_APP_SECRET", "d6b32159afff37f7eab2ffb9be680c16" );
// Khóa bí mật của ứng dụng Account Kit chỗ show ấy...
$code = $_POST['code'];
$csrf = $_POST['csrf'];
